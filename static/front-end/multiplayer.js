...
const userPawn = `pawn-${userColor}-normal`;
const userMaster = `pawn-${userColor}-master`;
const opponentPawn = `pawn-${opponentColor}-normal`;
const opponentMaster = `pawn-${opponentColor}-master`;
