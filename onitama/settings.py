"""
Django settings for onitama project.
...
WSGI_APPLICATION = 'onitama.wsgi.application'
...
#daphne
ASGI_APPLICATION = "onitama.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
AUTH_USER_MODEL = 'accounts.OnitamaUser'